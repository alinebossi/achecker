...
(function ($) {
    ...
    var inputDivMapping = {
		...
		"AC_by_monitor": {
			menuID: "AC_by_monitor",
            spinnerID: "AC_spinner_by_monitor"
		}
    };
    ...
    /**
     * Validates if a uri is provided on monitor
     */
    AChecker.input.validateURIMonitor = function () {
        // check uri
        disableClickablesAndShowSpinner(inputDivMapping.AC_by_monitor.spinnerID);
    };
